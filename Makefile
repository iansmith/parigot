...
build/runner: \
	...
	g/parigot/kernel/kernelservicedecl.p.go
	@echo
	@echo "\033[92mrunner =============================================================================================\033[0m"
	go build -o build/runner github.com/iansmith/parigot/command/runner

g/parigot/log/logservicedecl.p%go g/parigot/net/netservicedecl.p%go g/parigot/kernel/kernelwasm-undefined%txt g/parigot/kernel/kernelservicedecl.p%go: build/protoc-gen-parigot
	@echo
