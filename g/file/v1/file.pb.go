...
var file_file_v1_file_proto_rawDesc = []byte{
	...
	0x72, 0x72, 0x6f, 0x72, 0x10, 0x10, 0x1a, 0x05, 0xd8, 0x9e, 0x89, 0x02, 0x01, 0x32, 0xa3, 0x03,
	...
	0x6d, 0x2f, 0x69, 0x61, 0x6e, 0x73, 0x6d, 0x69, 0x74, 0x68, 0x2f, 0x70, 0x61, 0x72, 0x69, 0x67,
	0x6f, 0x74, 0x2f, 0x67, 0x2f, 0x66, 0x69, 0x6c, 0x65, 0x2f, 0x76, 0x31, 0x3b, 0x66, 0x69, 0x6c,
...
var file_file_v1_file_proto_depIdxs = []int32{
	...
	5,  // 19: file.v1.File.Open:output_type -> file.v1.OpenResponse
	4,  // 20: file.v1.File.Create:output_type -> file.v1.CreateResponse
	6,  // 21: file.v1.File.Close:output_type -> file.v1.CloseResponse
	8,  // 22: file.v1.File.LoadTestData:output_type -> file.v1.LoadTestDataResponse
	10, // 23: file.v1.File.Read:output_type -> file.v1.ReadResponse
	12, // 24: file.v1.File.Write:output_type -> file.v1.WriteResponse
	14, // 25: file.v1.File.Delete:output_type -> file.v1.DeleteResponse
